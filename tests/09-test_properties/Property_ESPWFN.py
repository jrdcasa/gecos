...
p_localdir = '/home/jramos/PycharmProjects/GITHUB_REPO_DIR/GeCos_tutorials/C001_EVOH_CCCOCC_localhost/01-CONF_RDKIT_LOCAL_ESPWFN/'
...
p_g16_keywords = '#p M062X/6-311G**  opt  scrf=(PCM, solvent=Water)  int=grid=ultrafine scf=(maxcycle=5000) geom=connectivity pop=(full,chelpg,readradii) output=wfn IOp(3/33=1) nosymm'
p_databasefullpath = '/home/jramos/PycharmProjects/GITHUB_REPO_DIR/GeCos_tutorials/C001_EVOH_CCCOCC_localhost/01-CONF_RDKIT_LOCAL_ESPWFN/01-Freq.db'
p_fileoutputfullpath = '/home/jramos/PycharmProjects/GITHUB_REPO_DIR/GeCos_tutorials/C001_EVOH_CCCOCC_localhost/01-CONF_RDKIT_LOCAL_ESPWFN/01-Freq.log'
p_pattern = 'WFN'
p_dockrmsdpack = '/home/jramos/PycharmProjects/sandbox_GeCos/lib/python3.8/site-packages/gecos-0.1-py3.8.egg/thirdparty/dockrmsd.x'
